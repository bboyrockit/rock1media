<?php 
	...
	$hide_more_button = airtheme_get_option('theme_option_show_post_more_button');
	$hide_more_button_class = $hide_more_button ? 'hidden' : false;
    ...
    <nav class="post-navi-single row">
        <div class="container">
            ...
            <?php }elseif($last_post){ ?>
                <div class="post-navi-unit post-navi-unit-prev col-sm-5 col-md-5 col-xs-4 ttt">
            ...
            <div class="post-navi-go-back col-sm-2 col-md-2 col-xs-4">
                <a class="post-navi-go-back-a <?php echo sanitize_html_class($hide_more_button_class); ?>" href="#" data-postid="<?php echo esc_attr(get_the_ID()); ?>"><span class="post-navi-go-back-a-inn"></span></a>
            </div>
