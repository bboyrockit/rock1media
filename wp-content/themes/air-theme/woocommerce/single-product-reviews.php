						...
						<li id="comment-<?php echo esc_attr($comment->comment_ID); ?>" class="commlist-unit">
							<div class="comm-u-wrap">
								...
								<div class="comment-meta">
									...
									<span class="date"><?php echo human_time_diff(get_comment_date('U', $comment->comment_ID), current_time('timestamp'));  esc_html_e(" ago",'air-theme'); ?></span>
									<?php if ( wc_review_ratings_enabled() ) { ?>
									<span class="rating_container">
									<div class="star-rating" title="<?php echo sprintf(esc_html__( 'Rated %d out of 5', 'air-theme' ), $rating) ?>"><span style="width:<?php echo (intval(get_comment_meta($comment->comment_ID, 'rating', true ) ) / 5 ) * 100; ?>%"><strong itemprop="ratingValue" class="rating"><?php echo intval(get_comment_meta($comment->comment_ID, 'rating', true)); ?></strong> <?php _e( 'out of 5', 'air-theme' ); ?></span></div>
									</span>
									<?php } ?>
