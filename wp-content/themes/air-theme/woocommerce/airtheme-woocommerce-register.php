...
function airtheme_woocommerce_enqueue_scripts(){
	wp_register_script('airtheme-woocommerce', UX_WOOCOMMERCE. '/js/woocommerce.js', array('jquery'), '0.0.1', true);
	wp_register_style('airtheme-woocommerce', UX_WOOCOMMERCE. '/css/woocommerce.css', array(), '0.0.1', 'screen');
