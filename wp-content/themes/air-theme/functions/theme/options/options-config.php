			...
			array(
				...
				'section' => array(
					...
					array(/* Portfolio List */
						'title' => esc_html__('Portfolio List','air-theme'),
						'item' => array(
							array('title'       => esc_html__('Use Original Images for Thumbnails','air-theme'),
							  'description' => esc_html__('the Feature Images would be scaled for the blocks in order to optimize the web page loading speed, turn on this option if you want to use your original images','air-theme'),
							  'type'        => 'switch',
